...
# # print(f"dataset length: {len(test_dataset)} test loader length: {len(test_loader)}")
...
# # print(f"{len(all_preds)} and {len(all_labels)}")
...
# # # Print the confusion matrix in a designed format
# # print("Confusion Matrix:")
# # print("             Predicted Negative  Predicted Positive")
# # print("Actual Negative          {}             {}".format(TN, FP))
# # print("Actual Positive          {}             {}".format(FN, TP))
...
#     TP = cm[1, 1]
# else:
#     raise ValueError("Confusion matrix shape is not as expected. Expected (2, 2).")
